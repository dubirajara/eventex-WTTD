...
class PeriodManagerTest(TestCase):
    def setUp(self):
        Talk.objects.create(title='Morning Talks', start='11:59')
        Talk.objects.create(title='Afternoon Talks', start='12:00')
